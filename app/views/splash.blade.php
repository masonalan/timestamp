...
<html>
  ...
  <head>
    ...
    <link href="{{asset('assets/css/soon.css')}}" rel="stylesheet">
  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>Timestamp</b> we aren't ready... </h1>
                Coming summer 2014
                <br>
                <br>
                <br>
            ...
            <div class="col-lg-4 col-lg-offset-4 mt centered">
				...
				<form class="form-inline" role="form" method="POST" action="{{action('HomeController@subscribe')}}">
